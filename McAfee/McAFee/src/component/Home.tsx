...
const Home = () => {
  ...
  const dashboardOptions = [
    { name: "Dashboard", link: "#" },
    { name: "Windows", link: "#", optional: true },
    { name: "Microsoft Office", link: "#", optional: true },
    { name: "Servers", link: "#", optional: false },
    { name: "Other Products", link: "#", optional: false },
    { name: "Settings", link: "#", optional: true }
  ];

  const recentPost = [
    { name: "OFFICE", link: "#", description:"How to Troubleshoot MS Office Crashes on Windows", img:"/office1.webp" },
    { name: "OFFICE", link: "#", optional: true, description:"Top Free Alternatives to Microsoft Office for Windows", img:"/office2.jpg" },
    { name: "WINDOWS", link: "#", optional: true, description:"How to Keep Your PC Running Smoothly", img:"/windows1.webp" },
    { name: "OFFICE", link: "#", optional: false, description:"How to Set Up Microsoft Office 365 on Your Windows PC", img:"/office3.webp" },
    { name: "WINDOWS", link: "#", optional: false, description:"How to Install Microsoft Office on Windows for the First Time", img:"/window2.jpg" },
    { name: "WINDOWS", link: "#", optional: true, description:"How to Optimize Windows for Better Performance", img:"/window3.webp" }
  ];
          ...
          <div>
            {dashboardOptions.map((item, index) => (
              <a
                ...
                onClick={() => item.optional && toggleDropdown(item.name)} // Add toggleDropdown here
              >
                {item.name}
              </a>
            ))}
                ...
                {recentPost.map((items, index) => (
                  <li key={index} className="border-b pb-4 flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="font-bold text-[#dce9dd] ">{items.description}</p>
                    </div>
                  </li>
                ))}
              </ul>
