  ...
  return (
    <div className="bg-gray-100 min-h-screen">
      ...
      <section className="bg-blue-100 text-center py-10">
        ...
        <button className="bg-[#42722b] text-white px-6 py-2 rounded mt-4">
          GET STARTED
        </button>
      </section>
      ...
      {/* Main Content */}
      <div className="max-w-4xl mx-auto bg-[#c6e1c6] p-6 shadow-md rounded-lg">
        ...
        <div className="mt-4">
          ...
          <p className="text-gray-700">Enter the activation key found on the retail card.</p>
        </div>
